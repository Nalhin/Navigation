...
class BidirectionalPathSummaryTest extends Specification {
  ...
  def "getSimplePath() should return path consisting of vertices"() {
    ...
    def pathSummary = new BidirectionalPathSummary(path, [] as Set, [] as Set)
    when:
  ...
  def "totalVisitedVertices() should return the number of visited vertices"() {
    ...
    def pathSummary = new BidirectionalPathSummary([], visitedVertices, visitedVertices)
    when:
  ...
  def "searchBoundaries() should return path search boundaries"() {
    ...
    def pathSummary = new BidirectionalPathSummary([],
        [firstVertex, secondVertex, thirdVertex] as Set,
        [thirdVertex, firstVertex, secondVertex] as Set)
    when:
