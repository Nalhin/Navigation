...
class DijkstraPathfindingStrategyTest extends Specification {
  ...
  static Graph buildTestGraph(GraphNode start, GraphNode end) {
    ...
    def nodes = [new GraphNode(3333, new Coordinates(40.71494, -73.9636)),
                 new GraphNode(4444, new Coordinates(40.74095, -73.8920)),
                 new GraphNode(5555, new Coordinates(40.74803, -73.78496)),
                 new GraphNode(6666, new Coordinates(40.74023, -73.7415)),
                 new GraphNode(7777, new Coordinates(40.6646, -73.6676))]
    def connections = [
        [start, nodes[0]],
        [nodes[2], nodes[3]],
        [nodes[0], nodes[1]],
  ...
  def "findShortestPath() should return the shortest path"() {
    given:
    def start = new GraphNode(1, new Coordinates(40.6227, -73.9393))
    def end = new GraphNode(2, new Coordinates(40.6531, -73.7769))
